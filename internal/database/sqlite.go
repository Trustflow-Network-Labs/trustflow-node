...
INSERT INTO settings ("key", "description", "setting_type", "value_boolean") VALUES ('accept_job_data_receipt_acknowledgement', 'Accept Job Data Receipt Acknowledgements sent by other peers', 'BOOLEAN', 1) ON CONFLICT(key) DO UPDATE SET "description" = 'Accept Job Data Receipt Acknowledgements sent by other peers', "setting_type" = 'BOOLEAN', "value_boolean" = 1;
